...
// This isnt my work. I found this in a gist and it just seemed easier to use than implement it myself
// I did make the functions none static for the sake of testing and added a few convenience functions
...
extension Storage {
    ...
    func retrieveFromCache<T: Decodable>(_ fileName: String, as type: T.Type) -> T {
        retrieve(fileName, from: .caches, as: type)
    }
}
